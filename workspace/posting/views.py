...
def addPost(request):
    ...
    return render(request, 'posting/post_add.html', {'form':form, 'is_add':True})
          
        
# post_obj = Post.objects.get(id = int(post_id))        
#글 수정하기
def editPost(request, postid):
    info = Post.objects.get(id = int(postid))
    form = PostForm(request.POST or None, instance = info)
    ...
    # request.method == 'GET' or invalid
    return render(request, 'posting/post_edit.html', {'form':form, 'is_add':False})
