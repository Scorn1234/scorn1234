...
def update_user(request):
    ...
    if request.method == 'POST' and user_form.is_valid() and image_form.is_valid():
        ...
        img.user = user
        img.save()
        return HttpResponseRedirect('accounts/mypage.html')
        
    return render(request, 'accounts/user_manage.html', {'form': user_form, 'image_form':image_form})
...
def update_img(request):
    ...
    return render(request, 'accounts/user_manage.html', {'form':form,})
